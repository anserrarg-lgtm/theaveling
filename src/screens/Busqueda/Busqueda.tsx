...
export default function Busqueda() {
  ...
  return (
    <div className="min-h-screen bg-[rgb(1,20,20)] text-white-100">
      <header className="fixed top-0 left-0 right-0 z-20 flex items-center gap-3 px-5 pt-5 pb-3 bg-[rgb(1,20,20)]">
        <button
          onClick={() => navigate(-1)}
          aria-label="Volver"
      ...
      <div className="flex flex-col gap-3 px-5 pt-20 pb-10">
