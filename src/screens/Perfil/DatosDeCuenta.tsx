  ...
  return (
    <div className="min-h-screen bg-thea-green text-white-100">
      {/* Header fijo — 2026-09-03, a pedido de Ana: cualquier pantalla con
          ...
          RGB, 100% opaco. */}
      <header className="fixed top-0 left-0 right-0 z-20 h-14 flex items-center gap-3 px-5 bg-[rgb(1,20,20)] border-b border-white-12">
      ...
      <div className="flex flex-col gap-4 px-5 pt-14 mt-2">
