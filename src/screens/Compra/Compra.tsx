...
export default function Compra() {
  ...
  return (
    <div className="min-h-screen bg-thea-green text-white-100">
      ...
      <header className="fixed top-0 left-0 right-0 z-20 h-[calc(56px_+_var(--safe-top))] pt-[var(--safe-top)] flex items-center gap-2 px-5 bg-[rgb(1,20,20)] border-b border-white-12">
        <button
          onClick={() => navigate(-1)}
          aria-label="Volver"
      ...
      <div className="pt-[calc(56px_+_var(--safe-top))] pb-28 px-5 flex flex-col gap-8">
